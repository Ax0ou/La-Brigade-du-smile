    ...
    return (
        ...
        >
            <div className="relative md:sticky md:top-0 h-auto md:h-screen w-full md:overflow-hidden">
                <div className="relative flex h-full min-h-screen md:min-h-0 items-center justify-center px-4 md:px-6 py-8 md:py-0">
                    <div className="container relative z-10 mx-auto grid max-w-6xl gap-12 md:grid-cols-2 md:items-center">

                        {/* Left Column: Text */}
                        <motion.div
                            className="space-y-8 text-center md:text-left pt-20 md:pt-0"
